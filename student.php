...
<body>
			...
			<div class="container">
				...
				<?php
					...
					{
						$q=mysqli_query($db,"SELECT `firstname`, `lastname`, `username`, `rollno`, `email`, `mobile` FROM `student` where `username` LIKE '%$_POST[search]%';");
					...
					{
						$res=mysqli_query($db,"SELECT `firstname`, `lastname`, `username`, `rollno`, `email`, `mobile` FROM `student` ORDER BY `student`.`firstname` ASC;");
