...
<body style="background-color: #250722ed;">
	...
	<?php
		if(isset($_POST['submit']))
		{
			...
			$sql1 = "UPDATE `admin` SET firstname = '$firstname', lastname = '$lastname', username = '$username', email = '$email', mobile = '$contact', password = '$password', propic = '$proph' WHERE username = '".$_SESSION['login_user']."';";
