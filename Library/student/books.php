	...
	<div id="main">
		...
		<div class="srch">
			<form class="navbar-form" method="post" name="form1">
				...
				<button style="background-color: #6826f9b8;" type="submit" name="submit" class="btn btn-primary">
			...
			<form class="navbar-form" method="post" name="form2">
				...
				<button style="background-color: #6826f9b8;" type="submit" name="submit1" class="btn btn-primary">Request
				</button>
			</form>
		</div>
