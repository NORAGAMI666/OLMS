	...
	<div id="main">
		...
		<div class="container">
			...
			?>			
					...
					<div style="float: right;padding-left: 25px;padding-top: 5px;">
						<?php
							$var = 0;
...
<br><br><br><br><br><br><br>
			...
			<?php
				...
				if(isset($_SESSION['login_user']))
				{
					...
					{
						$sql="SELECT student.username, rollno, books.bookid, name, authors, edition, approve, issuedate, returndate FROM student inner join issue_book on student.username=issue_book.username inner join books on issue_book.bookid=books.bookid where issue_book.approve !='' and issue_book.approve !='Approved' and issue_book.username ='$_SESSION[login_user]' ORDER BY `issue_book`.`returndate` DESC;";
						$res=mysqli_query($db,$sql);
					}
